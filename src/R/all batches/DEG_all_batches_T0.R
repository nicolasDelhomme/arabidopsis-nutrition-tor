...
#' # Export list of DEGs
dir.create(here("data/GO"),showWarnings=FALSE,recursive=TRUE)
write.table(T6NPSDMSO_Low, file = here("data/GO/T6NPSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6PKSDMSO_Low, file = here("data/GO/T6PKSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6NSDMSO_Low, file = here("data/GO/T6NSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6NPDMSO_Low, file = here("data/GO/T6NPDMSO_Low.txt"), sep ="\t", row.names = FALSE)

write.table(T6NPSDMSO_High, file = here("data/GO/T6NPSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6PKSDMSO_High, file = here("data/GO/T6PKSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6NSDMSO_High, file = here("data/GO/T6NSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6NPDMSO_High, file = here("data/GO/T6NPDMSO_High.txt"), sep ="\t", row.names = FALSE)

write.table(T6NPSAZD_Low, file = here("data/GO/T6NPSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6PKSAZD_Low, file = here("data/GO/T6PKSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6NSAZD_Low, file = here("data/GO/T6NSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T6NPAZD_Low, file = here("data/GO/T6NPAZD_Low.txt"), sep ="\t", row.names = FALSE)

write.table(T6NPSAZD_High, file = here("data/GO/T6NPSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6PKSAZD_High, file = here("data/GO/T6PKSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6NSAZD_High, file = here("data/GO/T6NSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T6NPAZD_High, file = here("data/GO/T6NPAZD_High.txt"), sep ="\t", row.names = FALSE)


write.table(T24NPSDMSO_Low, file = here("data/GO/T24NPSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24PKSDMSO_Low, file = here("data/GO/T24PKSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24NSDMSO_Low, file = here("data/GO/T24NSDMSO_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24NPDMSO_Low, file = here("data/GO/T24NPDMSO_Low.txt"), sep ="\t", row.names = FALSE)

write.table(T24NPSDMSO_High, file = here("data/GO/T24NPSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24PKSDMSO_High, file = here("data/GO/T24PKSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24NSDMSO_High, file = here("data/GO/T24NSDMSO_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24NPDMSO_High, file = here("data/GO/T24NPDMSO_High.txt"), sep ="\t", row.names = FALSE)

write.table(T24NPSAZD_Low, file = here("data/GO/T24NPSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24PKSAZD_Low, file = here("data/GO/T24PKSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24NSAZD_Low, file = here("data/GO/T24NSAZD_Low.txt"), sep ="\t", row.names = FALSE)
write.table(T24NPAZD_Low, file = here("data/GO/T24NPAZD_Low.txt"), sep ="\t", row.names = FALSE)

write.table(T24NPSAZD_High, file = here("data/GO/T24NPSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24PKSAZD_High, file = here("data/GO/T24PKSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24NSAZD_High, file = here("data/GO/T24NSAZD_High.txt"), sep ="\t", row.names = FALSE)
write.table(T24NPAZD_High, file = here("data/GO/T24NPAZD_High.txt"), sep ="\t", row.names = FALSE)
